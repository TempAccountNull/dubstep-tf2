...
public:
	...
	{
		using OriginalFn = int(__thiscall*)(void*, const vec3_t&, vec3_t&);
		return GetVFunc<OriginalFn>(this, 12)(this, point, screen);
	};
	//virtual int ScreenPosition(float flXPos, float flYPos, Vector& screen) = 0;

	virtual class OverlayText_t *GetFirst( void ) = 0;
	virtual class OverlayText_t *GetNext(class OverlayText_t *current ) = 0;
